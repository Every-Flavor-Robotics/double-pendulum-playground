...
import wandb
from inverted_double_pendulum_mjx import InvertedDoublePendulumEnv, default_config
...
def brax_ppo_config() -> config_dict.ConfigDict:
...
_ACTION_REPEAT = flags.DEFINE_integer("action_repeat", 5, "Action repeat")
...
def main(argv):
    ...
    eval_env = InvertedDoublePendulumEnv()
